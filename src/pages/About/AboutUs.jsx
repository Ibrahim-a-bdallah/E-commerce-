        ...
        <div className="Main top-[257.5px] gap-[55px]">
            <div className="Header flex flex-col relative"> 
                <div className='bg-neutral-900'>
                    <img alt="" className=" w-full h-96 bg-center bg-cover opacity-50" style={{backgroundImage:`url(${AboutUs1})`}}/>
                </div>
                <div className=' absolute max-w-[1200px] gap-[7px] pt-36 pl-12 pr-7 md:pt-[160px] pb-[268px] md:pl-[450px] flex flex-col'>
                    <div className=' flex flex-col'>
                        <h1 className='font-semibold text-5xl leading-[72px] tracking-[0%] text-center align-middle text-[#FFFFFF]'>About for Bacola</h1>
                    </div>
                    <div className=' flex flex-col'>
                        <p className='font-semibold text-[12px] leading-[14.4px] tracking-[4px] text-center align-middle uppercase text-[#FFFFFF]'>We can do more for you</p>
                    </div>
                </div>
            </div>
                                ...
                                <div className=' max-w-[592.5px]  pt-[60px] pr-[15px] lg:pb-[216.56px] pb-10 pl-[15px] lg:pl-10'>
                                    ...
                                    <div className='pt-4 ' >
                                        <p className=' font-semibold text-[28px] leading-[33.6px] tracking-[0%] align-middle text-[#202435]'>
                                            ...
                                            <p className='font-semibold text-[28px] leading-[33.6px] tracking-[0%] align-middle text-[#202435]'>Pellentesque habitant morbi</p>
                                    </div>
                            ...
                            <div className=' lg:bottom-35 lg:left-[200px] rounded-[7px] bg-[#FFFFFF] lg:absolute md:p-10 pt-5 '>
                                    <p className=' font-normal text-[14px] leading-[24px] tracking-[0%] align-middle text-[#202435] lg:pr-40 '>
                                        ...
                                        tristique et ultricies nec,consectetur quis enim. Nullam id rutrum ex. Aliquam a lectus id lacus rhoncus dapibus non ac justo.
                                         Vivamus lacinia vestibulum metus indapibus. Vestibulum sit amet sollicitudin enim. Ut id interdum turpis. Curabitur porta auctor quam, 
                                         pretium facilisis nisl. Pellentesque efficitur elitante, vel vulputate tortor blandit nec.
                                    </p>
                            </div>   
            </div>
        </div>
