        ...
        <div className='flex flex-col lg:flex-row gap-6'>
          <div className='w-full lg:w-1/2 border-r border-[#DEDEDE] pr-6'>
            <div className='flex justify-between items-center '>
              ...
              <p className={styles.editLink}><a href="#">Login</a></p>
            </div>
            <form>
              <div className="my-4">
                <input
              ...
              <div className='mt-14'>
                <h2 className='font-semibold text-xl pb-2 text-black'>Delivery</h2>
              </div>
              ...
              <div className='my-7'>
                <h2 className='font-semibold text-xl pb-2 text-black'>Shipping method</h2>
              ...
              <div className='my-7 '>
                <div>
                  <h2 className='font-semibold text-xl pb-2 text-black'>Payment</h2>
                ...
                <div className='my-4 p-4 bg-[#F5F5F5] flex justify-center flex-col items-center text-center rounded'>
                  <div className='mb-2'>
                    <img src={iconPayment} alt="Payment Icon" className='w-20 h-20 ' />
                  </div>
            ...
            <ul>
              <li className='flex justify-between items-center  py-4'>
                <div className='flex items-center gap-4'>
                  <div className={`w-16 h-16 border border-[#DEDEDE] rounded shadow-md ${styles['product-image']}`}>
                    <span className={`bg-[#4B4B4B] text-white flex justify-center items-center ${styles['product-count']}`}>1</span>
                  </div>
                  <p className="font-semibold text-base">All Natural Italian-Style Chicken Meatballs</p>
                </div>
              ...
              <li className='flex justify-between items-center  py-4'>
                <div className='flex items-center gap-4'>
                  ...
                  <p className="font-semibold text-base">Coca-Cola – 2 L Bottle</p>
                </div>
                <span className='font-medium'>$9.99</span>
              </li>
              <li className='flex justify-between items-center py-4'>
                <div className='flex items-center gap-4'>
                  ...
                  <p className="font-semibold text-base">Fairlife Lactose-Free 2% Milk</p>
                </div>
                <span className='font-medium'>$9.99</span>
              </li>
            </ul>.
            <div>
              <div className='flex justify-between items-center pt-4'>
                <p className="text-base">
                  Subtotal · <span className="font-medium">3 items</span>
                </p>
                <span className='text-base font-semibold'>$29.97</span>
              </div>
              <div className='flex justify-between items-center pt-4'>
              ...
              <div className='flex justify-between items-center py-7'>
                ...
                <span className='text-base font-semibold'><span className='font-light text-[#666666]'>USD</span> $14.79</span>
              </div>
